...
function create() {
  ...
  const submitTrainForm = (e) => {
    ...
    if (existingTrainNumbers.includes(trainNumber)) {
  ...
  const createNewTrainController = (e) => {
    e.preventDefault();
    dispatch(createTrainControlAction({ number: trainNumber, cars: carsList }));
    ...
    <div>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={(e) => createNewTrainController(e)}
          >
            Save Changes
          </Button>
        </Modal.Footer>
          ...
          {carsList &&
            carsList.map((car) => (
              ...
              >
                ...
                <Button variant='danger' onClick={(e)=>handleRemove(e,car)}>Remove</Button>
              </ListGroup.Item>
            ))}
        </ListGroup>
      </Form>
